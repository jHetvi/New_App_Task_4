import 'dart:convert';
import 'package:draba_task3/model/specialModel.dart';
...
class SpecialTab extends StatefulWidget {
  @override
  _SpecialTabState createState() => _SpecialTabState();
}
...
Future<SpecialModel> getUser() async {
  final url =
  ...
  if (response.statusCode > 200 || response.statusCode < 600) {
    ...
    return SpecialModel.fromJson(jsonCard);
  } else {
